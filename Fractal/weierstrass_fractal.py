...
plt.subplots_adjust(left=0.1, bottom=0.3) # Adjust bottom to make space for radio buttons
...
ax_radio = plt.axes([0.1, 0.05, 0.8, 0.05]) # Position for two radio buttons
