...
# Adjust bottom to make space for radio buttons and new labels
...
slider_a = Slider(ax_a, '', 0.01, 0.99, valinit=init_a,
                  valstep=0.01)  # Empty label for the slider itself
...
# Slider bottom + height + small offset
...
radio_buttons = RadioButtons(
    # 'Raw Values' is default
    ax_radio, ['Raw Values', 'Show Density'], active=0)
